	...
	<cffunction name="getRawHtmlResults" access="public" returntype="string" output="false" hint="Returns a _raw_ HTML representation of the TestResult">
		...
		<cfsavecontent variable="result">
			<cfoutput>
				...
				<!---<cfdump var="#request.cfspecMetaData#">--->
				<cfif structKeyExists(request,"executionPlan") AND structKeyExists(url,"showexecutionplan")>
					<cfoutput>#request.executionPlan#</cfoutput>	
				</cfif>
